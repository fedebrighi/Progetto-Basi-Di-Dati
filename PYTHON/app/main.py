...
class CampionatoApp:
    ...
    def create_widgets(self):
        ...
        self.btn_iscrizione = ttk.Button(main_frame, text="Iscrizione Squadra", command=self.open_iscrizione, width=button_width)
        self.btn_iscrizione.grid(column=0, row=2, padx=10, pady=10, sticky=(tk.W, tk.E))

        self.btn_scambio = ttk.Button(main_frame, text="Proporre Scambio Giocatori", command=self.open_scambi, width=button_width)
        self.btn_scambio.grid(column=1, row=2, padx=10, pady=10, sticky=(tk.W, tk.E))

        self.btn_infortunio = ttk.Button(main_frame, text="Infortuni", command=self.open_infortuni, width=button_width)
        self.btn_infortunio.grid(column=0, row=3, padx=10, pady=10, sticky=(tk.W, tk.E))

        self.btn_visualizza_squadre = ttk.Button(main_frame, text="Visualizza Squadre", command=self.open_visualizza_squadre, width=button_width)
        self.btn_visualizza_squadre.grid(column=1, row=3, padx=10, pady=10, sticky=(tk.W, tk.E))

        self.btn_visualizza_classifica = ttk.Button(main_frame, text="Visualizza Classifica", command=self.open_visualizza_classifica, width=button_width)
        self.btn_visualizza_classifica.grid(column=0, row=4, padx=10, pady=10, sticky=(tk.W, tk.E))

        self.btn_eliminazione_squadra = ttk.Button(main_frame, text="Eliminazione Squadra", command=self.open_eliminazione_squadra, width=button_width)
        self.btn_eliminazione_squadra.grid(column=1, row=4, padx=10, pady=10, sticky=(tk.W, tk.E))

        self.btn_visualizza_giocatori = ttk.Button(main_frame, text="Visualizza Giocatori", command=self.open_visualizza_giocatori, width=button_width)
        self.btn_visualizza_giocatori.grid(column=0, row=5, padx=10, pady=10, sticky=(tk.W, tk.E))

        self.btn_inserisci_giocatore = ttk.Button(main_frame, text="Inserisci Giocatori nelle Squadre", command=self.open_inserisci_giocatore, width=button_width)
        self.btn_inserisci_giocatore.grid(column=1, row=5, padx=10, pady=10, sticky=(tk.W, tk.E))

        self.btn_blocca_giocatore_espulso = ttk.Button(main_frame, text="Blocca/Sblocca Giocatore Espulso", command=self.open_blocca_giocatore_espulso, width=button_width)
        self.btn_blocca_giocatore_espulso.grid(column=0, row=6, padx=10, pady=10, sticky=(tk.W, tk.E))

        self.btn_organizza_partite = ttk.Button(main_frame, text="Organizzazione Partite tra Squadre", command=self.open_organizza_partite, width=button_width)
        self.btn_organizza_partite.grid(column=1, row=6, padx=10, pady=10, sticky=(tk.W, tk.E))

        self.btn_gestione_sponsor_squadra = ttk.Button(main_frame, text="Gestione Sponsor Squadra", command=self.open_gestione_sponsor_squadra, width=button_width)
        self.btn_gestione_sponsor_squadra.grid(column=0, row=7, padx=10, pady=10, sticky=(tk.W, tk.E))

        self.btn_gestione_sponsor_torneo = ttk.Button(main_frame, text="Gestione Sponsor Torneo", command=self.open_gestione_sponsor_torneo, width=button_width)
        self.btn_gestione_sponsor_torneo.grid(column=1, row=7, padx=10, pady=10, sticky=(tk.W, tk.E))

        self.btn_visualizza_ricavi_torneo = ttk.Button(main_frame, text="Visualizza Ricavi Torneo", command=self.open_visualizza_ricavi_torneo, width=button_width)
        self.btn_visualizza_ricavi_torneo.grid(column=0, row=8, padx=10, pady=10, sticky=(tk.W, tk.E))

        self.btn_visualizza_calendario = ttk.Button(main_frame, text="Visualizza Calendario Partite", command=self.open_visualizza_calendario, width=button_width)
        self.btn_visualizza_calendario.grid(column=1, row=8, padx=10, pady=10, sticky=(tk.W, tk.E))
        
        self.btn_retrocessione = ttk.Button(main_frame, text="Controlla Retrocessioni", command=self.controlla_retrocessioni, width=button_width)
